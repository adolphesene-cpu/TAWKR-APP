...
import { useMediaQuery } from '@/hooks/use-mobile'; // Import the useMediaQuery hook
...
const Navbar = () => {
  ...
  const isDesktop = useMediaQuery("(min-width: 768px)"); // Define breakpoint for desktop
  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button variant="ghost" size="icon" className="md:hidden fixed top-4 left-4 z-[100]">
          <Menu className="h-6 w-6" />
        </Button>
      </SheetTrigger>
      <SheetContent side="left" className="w-64 p-4 flex flex-col bg-primary text-primary-foreground">
        <SheetHeader>
